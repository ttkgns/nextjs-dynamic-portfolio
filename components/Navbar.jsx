  ...
  return (
    <>
      ...
      <nav className={`w-full flex items-center justify-between fixed px-5 lg:px-8 xl:px-[8%] py-4 z-50
        ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:border dark:border-white/20" : ""}`}>
        <a href="#top">
          {/* <Image src={assets.logo} alt="logo" className="w-28 cursor-pointer mr-14" /> */}
          <h1 className='md:ml-10 lg:ml-20 text-4xl font-bold text-primary upper font-ovo'>{personalData.name} • </h1>
        </a>
